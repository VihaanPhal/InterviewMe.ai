        ...
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          ...
          <div className="hidden lg:relative lg:block lg:p-12">
            ...
            <h2 className="mt-6 text-3xl font-bold text-white sm:text-4xl md:text-5xl">
              Welcome to InterviewMe.AI
            </h2>

            <p className="mt-4 leading-relaxed text-white/90">
              Discover the best platform for managing your professional
              interviews. Enhance your skills and get ready to shine.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-xl lg:max-w-3xl">
            <div className="relative -mt-16 block lg:hidden">
              ...
              <p className="mt-4 leading-relaxed text-gray-500 dark:text-gray-400">
                Prepare for your next job interview with our AI-powered
                platform. Get personalized insights and practice questions.
              </p>
            </div>
